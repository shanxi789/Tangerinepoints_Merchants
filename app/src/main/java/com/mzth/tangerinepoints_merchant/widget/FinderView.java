package com.mzth.tangerinepoints_merchant.widget;
...
public class FinderView extends View {
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        //canvas.drawRect(middleRect.left + MIDDLE_LINE_PADDING, slideTop - MIDDLE_LINE_WIDTH/2, middleRect.right - MIDDLE_LINE_PADDING,slideTop + MIDDLE_LINE_WIDTH/2, paint);
        //画框
    ...
    private void init(Context context)
    {
        ...
        roi_box = context.getResources().getDrawable(R.drawable.capture);
